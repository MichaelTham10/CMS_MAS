    ...
    <div class="container-fluid">
        <div class="rounded border mt-4 mb-4 p-4" style="background-color: #fff">
            <div class="font-weight-bold">
                <div class="mb-3">
                    <h3>Edit Old PO Out</h3>
                </div>   
                <hr class="mt-0 mb-3"> 
                <form action="/update/old/po-out/{{$po_out->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="form-group">
                        <label for="attention">PO Out Number</label>
                        <input class="form-control" type="text" placeholder="Input PO Out Number" @error('po_out_number')
                        is invalid @enderror name="po_out_number" value="{{$po_out->po_out_no}}">
                        @error('po_out_number')
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="/old/po-out" class="btn btn-light">Cancel</a>
