...
class OldQuotationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $quotations = OldQuotation::all();
        return redirect('/old/quotation')->with('success', 'Old Quotation has been added');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/old/quotation')->with('success', 'Old Quotation has been updated');
    }

    public function delete($id)
    {
        OldQuotation::destroy($id);
        return back()->with('success', 'Old Quotation has been deleted');
    }
}
